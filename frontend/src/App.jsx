    ...
    <div className="app-wrapper">
      ...
      >
        <svg viewBox="0 0 24 24" width="28" height="28" fill="currentColor">
          <path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946C.06 5.348 5.397.01 12.008.01c3.202.001 6.212 1.246 8.477 3.514 2.266 2.268 3.507 5.28 3.505 8.484-.004 6.657-5.34 11.997-11.953 11.997-2.005-.001-3.973-.502-5.724-1.455L0 24zm6.59-4.846c1.6.95 3.498 1.45 5.419 1.451 5.44.002 9.865-4.422 9.869-9.863.002-2.634-1.025-5.11-2.887-6.974-1.862-1.863-4.337-2.89-6.973-2.891-5.441 0-9.868 4.422-9.873 9.864-.001 1.92.501 3.798 1.458 5.4l-.993 3.63 3.725-.977zm11.367-6.616c-.302-.15-1.785-.88-2.036-.972-.25-.09-.432-.135-.612.135-.18.27-.698.88-.857 1.06-.16.18-.318.2-.62.05-1.95-.972-2.733-1.63-3.77-3.414-.277-.475.277-.44.793-1.472.09-.18.045-.337-.02-.487-.068-.15-.612-1.473-.84-2.024-.22-.53-.443-.457-.612-.466-.16-.008-.344-.01-.528-.01-.184 0-.485.07-.74.35-.254.278-.97.95-.97 2.31 0 1.36.99 2.68 1.13 2.87.14.19 1.95 2.977 4.72 4.17 2.77 1.19 2.77.79 3.27.74.5-.05 1.78-.73 2.03-1.43.25-.7.25-1.3.175-1.43-.075-.13-.275-.205-.57-.355z"/>
        </svg>
        <span className="floating-whatsapp-text">Chat on WhatsApp</span>
      </a>
    </div>
  );
}
